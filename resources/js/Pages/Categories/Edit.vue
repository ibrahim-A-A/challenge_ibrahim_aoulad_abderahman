...
<!--============== Row =================-->
                ...
                <!--------- col-sm-6 ----------->
                    ...
                    <input v-model="detailsElement.name_category"  type="text" class="form-control" id="name_category" placeholder="Name category" required pattern=".{1,100}" title="You must enter between 1 and 100 letters">
                      </div>
              ...
              <!--------- col-sm-6 ----------->
                     ...
                     <label>Parent Categories :</label>
                          <select class="form-control" style="width: 100%;" v-model="detailsElement.parent_id">   
...
//====================================================               
            methods :{
              update()
               ...
               this.loading=true;
                this.$inertia.patch('/categories/update/'+this.detailsElement.id,this.detailsElement).then(()=>{
                    this.loading=false;
                          });                        
                 }catch(error){
                              } 
