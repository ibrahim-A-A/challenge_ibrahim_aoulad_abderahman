        ...
        <!--============== /Row =================-->
          <!--============== Row =================-->
                ...
                <!--------- col-sm-12 ----------->
                    ...
                    <input v-model="form.description"  type="text" class="form-control" id="description" placeholder="Descrption" required pattern=".{1,100}" title="You must enter between 1 and 250letters">
                      </div>
        ...
        <!--============== /Row =================-->
         <!--============== Row =================-->
                ...
                <!--------- col-sm-6 ----------->
                  ...
                  <input name="image" ref="image"  @change="imageSelected" id="image" type="file" class="form-control" pattern="([^\s]+(\.(?i)(jpg|png))$)" required>                                                                                      
                       </div>
